...
document.addEventListener("click",e => {
    ...
    input.addEventListener('keyup', e => { if (e.keyCode == 13) Calc() })
    if (target.classList.contains('btn-num')) input.value += target.innerText             if (target.classList.contains('btn-clear')) input.value = ''
